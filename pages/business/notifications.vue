...
.notification-container {
  ...
  min-width: 36rem; /* 672px */
  max-width: 44rem; /* 672px */
}
...
.notification-header {
  @apply text-xl font-semibold text-gray-600 mb-2 mt-5 pl-0 justify-self-start;
}
...
@media screen and (max-width: 640px) {
  ...
  .notification {
    @apply px-5 mx-0 w-full min-h-full py-4 max-h-96 relative 
