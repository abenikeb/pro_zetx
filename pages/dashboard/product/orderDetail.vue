<template>
  <div>
            ...
            <div class="mb-2 md:w-full">
              ...
              <div>
                ...
                <div class="flex flex-row gap-2 w-full pt-4 md:pt-2">
                  ...
                  >
                    <h1 v-if="order.orderNumber">#{{ order.orderNumber }}</h1>
                    <h1 v-else>#{{ $route.query.id }}</h1>
                    <h1>Stripe</h1>
                    <h1>
                      {{
            ...
            <div class="general-section">
              ...
              <div class="mt-8">
                <div v-if="order">
                  ...
                  <p v-if="order.status !== 'delivered'" class="text-xs">
                    Click the button to change the status
                  </p>
                </div>
                <div
                  v-if="!order"
                  class="animate-pulse h-5 bg-gray-200 rounded w-32 mb-2 mt-2"
                ></div>
                ...
                >
                  ...
                  <h1 v-if="loading" class="text-xs">Please Wait..</h1>
                </button>
                <button
                  v-if="!order"
          ...
          <div class="sub-container">
            ...
            <div class="mb-6 md:w-full">
              ...
              <div>
                ...
                <span v-if="order.orderNumber" class="italic">
                  #{{ order.orderNumber }}</span
                >
                <span v-else class="italic"> #{{ $route.query.id }}</span>
              </div>
              <p class="text-sm">
            ...
            <div class="general-section">
              ...
              >
                ...
                <div class="flex-1">
                  ...
                  <div>
                    <h1>Phone:</h1>
                    <p class="ml-2">{{ order.buyer.tel }}</p>
                  </div>
                </div>
                <!-- END customer Contact Information -->
                <!-- START Seller Contact Information -->
            ...
            <div class="mt-2">
              ...
              <div
                v-if="!order"
                class="animate-pulse h-5 bg-gray-200 rounded w-36 mb-2 mt-2"
              ></div>
    ...
    <div v-if="!order" class="relative px-2">
      <div
        class="
          max-w-md
          mx-auto
        ...
        buttons: [
          {
            ...
            handler: async () => {
              ...
              console.log('OrderStatusStateChanged', OrderStatusStateChanged)
...
.animation-class {
  @apply animate-pulse h-5 bg-gray-200 rounded w-36 mb-2;
}
.animation-class-width {
  @apply animate-pulse h-5 bg-gray-200 rounded w-52 mb-2;
}
</style>
